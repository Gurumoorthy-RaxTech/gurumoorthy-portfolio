...
{
    // Route group: /api/ado/employees
    [ApiController]
    [Route("api/ado/employees")]
    public class EmployeesAdoController : ControllerBase
    {
        private readonly IEmployeeRepository _employeeRepository;
        private readonly IDepartmentRepository _departmentRepository;

        public EmployeesAdoController(
            [FromKeyedServices("ado")] IEmployeeRepository employeeRepository,
            [FromKeyedServices("ado")] IDepartmentRepository departmentRepository)
        {
