...
namespace SchoolApp.DataAccess
{
    ...
    public class StudentRepository
    {
        ...
        {
            // Reads the "SchoolDb" entry straight out of App.config at startup.
        ...
        public List<Student> Search(string keyword)
        {
            ...
            using (var cmd = new SqlCommand(sql, conn))
            {
                // Parameterized - never string-concatenate user input into SQL text.
        ...
        public int Insert(Student s)
        {
            ...
            using (var cmd = new SqlCommand(sql, conn))
            {
                ...
                conn.Open();
                // ExecuteScalar, not ExecuteNonQuery, because the SQL text SELECTs the new identity value.
